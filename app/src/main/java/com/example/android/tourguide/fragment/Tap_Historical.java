...
public class Tap_Historical extends Fragment implements ItemClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        data = new ArrayList<>();
        data.add(new HistoricalDataType(R.drawable.pyramids, getResources().getString(R.string.pyramidstitle), getResources().getString(R.string.pyramidsdetail)));
        ...
        data.add(new HistoricalDataType(R.drawable.islamic,  getResources().getString(R.string.pyramidstitle), getResources().getString(R.string.pyramidsdetail)));
        ...
        data.add(new HistoricalDataType(R.drawable.abusimbel, getResources().getString(R.string.pyramidstitle), getResources().getString(R.string.pyramidsdetail)));
